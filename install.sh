...
if [ "${install_mode}" = 'desktop' ]; then
    pacstrap /mnt gdm gnome-session gnome-settings-daemon gnome-control-center nautilus gnome-shell gnome-console gnome-software adwaita-icon-theme flatpak pipewire-alsa pipewire-pulse pipewire-jack
